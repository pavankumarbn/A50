...
//! VirtualRC class has all the methods to mimic the RC functionality via
//! OnboardSDK.
class VirtualRC {
 public:
 ...
 public:
  ...
  void sendSafeModeData();  //! @deprecated This function will not be maintained
                            //! and will be deprecated in a future release -
                            //! please use neutralVRCSticks() instead.
  void neutralVRCSticks();  //! New function - this will replace
                            //! sendSafeModeData() in a future release.
 ...
 public:
  //! @warning old interface. Will be replaced by toRCData (see below) in a
  //! future release.
