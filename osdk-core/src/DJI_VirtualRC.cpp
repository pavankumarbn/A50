...
void VirtualRC::setControl(bool enable, VirtualRC::CutOff cutoffType) {
  ...
  api->send(0, encrypt, SET_VIRTUALRC, CODE_VIRTUALRC_SETTINGS, &setting,
            sizeof(setting));
}
...
void VirtualRC::sendData(VirtualRCData Data) {
  ...
  api->send(0, encrypt, SET_VIRTUALRC, CODE_VIRTUALRC_DATA, &vrcData,
            sizeof(vrcData));
}

//! This function will be deprecated in a future release. Please use
//! sendData(VirtualRCData Data) instead.
void VirtualRC::sendData() {
  api->send(0, encrypt, SET_VIRTUALRC, CODE_VIRTUALRC_DATA, &vrcData,
            sizeof(vrcData));
}

//! This function will not be maintained and will be deprecated in a future
//! release. Please use resetVRCData() instead.
...
*/
//! @warning This function will be deprecated in a future release. Please use
//! toRCData instead.
