...
/*! @mainpage
 * This is the officially maintained DJI Onboard SDK library. The library
 * provides a set of APIs for implementing the various functionality available
 * through the [open
 * protocol](https://developer.dji.com/onboard-sdk/documentation/introduction/index.html).
 *
 * @section intro_sec Introduction
 *
 * API class documentation is available here. Click on the
 * Files/Classes/Namespaces tabs above to see more information about the
 * library. \n
 * Documentation for the SDK has moved to the [DJI Developer
 * Website](https://developer.dji.com/onboard-sdk/documentation/).
 * Please refer to the [Programming
 * Guide](https://developer.dji.com/onboard-sdk/documentation/application-development-guides/programming-guide.html)
...
class CoreAPI {
 ...
 public:
   ...
   * (other two overloaded functions are builded on the base of this
   * function)\n\n
  ...
  void send(unsigned char session_mode, bool is_enc, CMD_SET cmd_set,
            unsigned char cmd_id, void *pdata, size_t len, int timeout = 0,
 ...
 public:
  ...
  static void activateCallback(CoreAPI *api, Header *protocolHeader,
                               UserData userData = 0);
