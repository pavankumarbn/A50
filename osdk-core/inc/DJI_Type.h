...
typedef struct Header {
  ...
  //! @warning this field will change reversed0 --> reserved0 in the next
  //! release
  unsigned int reversed0 : 2;  // always 0

  unsigned int padding : 5;
  unsigned int enc : 3;
  //! @warning this field will change reversed1 --> reserved1 in the next
  //! release
...
//! The CallBackHandler struct allows users to encapsulate callbacks and data in
//! one struct
...
//! @warning this struct will be deprecated in the next release and renamed to
//! Vector3fData. Use Vector3fData instead.
...
//! @warning the 'RadioData' struct will be deprecated in the next release and
//! renamed to RCData. Use RCData instead.
...
//! @warning the 'MagnetData' struct will be deprecated in the next release and
//! renamed to MagData. Use MagData instead.
...
//! @note This struct is provided as a means for users to provide sigle GPS
//! points to the SDK.
//!       It does not follow standard SDK GPS datatypes. This may change in a
//!       future release.
typedef struct GPSPositionData {
  float64_t latitude;
  float64_t longitude;
  //! @warning please provide relative height in the altitude field. The name
...
typedef struct RTKData {
  ...
  //! @warning the 'velocityGround' field will be renamed to velocityDown in the
  //! next release.
...
typedef struct BroadcastData {
  ...
  QuaternionData q;
  //! @warning the CommonData type will change to Vector3fData in a future
  //! release
  CommonData a;
  VelocityData v;
  //! @warning the CommonData type will change to Vector3fData in a future
